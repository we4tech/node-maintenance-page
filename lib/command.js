(function() {
  ...
  switches = [['-h', '--help', 'Print this help'], ['-P', '--port NUMBER', 'Server port, by default 80'], ['-H', '--host HOST', 'Server host, by default 0.0.0.0'], ['-m', '--mount-dir FILE', 'Server directory from where index.html and related resources will be served, Required']];
